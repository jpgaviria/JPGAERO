...
import os
#win
#os.chdir('C:\\Users\\jpgaviri\\iCloudDrive\\Personal\\Python\\Flying_Car_nano\\FCND-Controls')
#MAC
os.chdir('~/Library/Mobile\ Documents/com~apple~CloudDocs\\Personal\\Python\\Flying_Car_nano\\FCND-Controls')
...
class ControlsFlyer(UnityDrone):
    ...
    def position_controller(self):  
        ...
        self.local_position_target = np.array([25.0, -10.0, -10.0])
