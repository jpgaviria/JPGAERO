...
class CoaxialCopter:
    ...
    def z_dot_dot(self):
        ...
        acceleration = self.g -(self.k_f/self.m)*((self.omega_1*self.omega_1)+(self.omega_2*self.omega_2)) 
    ...
    def psi_dot_dot(self): 
        ...
        angular_acc = - (self.k_m/self.i_z)*(-(self.omega_1*self.omega_1)+(self.omega_2*self.omega_2))
