...
class Drone2D:
    ...
    def set_rotors_angular_velocities(self,linear_acc):
        ...
        self.k_m = 1
        # TODO
        #self.omega_1 = - np.sqrt(-((self.i_z*angular_acc)/(2*self.k_m))-((self.m*(-linear_acc-self.g))/(2*self.k_f)) ) 
        #self.omega_2 = np.sqrt( ((self.i_z*angular_acc)/(2*self.k_m))-((self.m*(-linear_acc-self.g))/(2*self.k_f)) )
